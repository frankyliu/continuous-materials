public interface TaskNames {
    ...
    public static final String TASK_INTERNAL_STORE_LATEST_VERSION = "intStoreLatestVersion";

    public static final String TASK_FETCHED_DEPENDENCIES = "fetchedDependencies";
    ...
    public static final String TASK_SOLEIL_DISTRIBUTION = "soleilDistribution";
